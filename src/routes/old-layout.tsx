    ...
    https://res.cloudinary.com/dr1p6nhsi/image/upload/v1665667572/avatar_ioeru9.webp 1800w`}
          ...
          <div class="flex flex-col h-full">
            ...
            <p class="text-xs mt-4">
              ...
              things. I'm currently learning Rust, Deno and Fresh. <br /> Want
              to have a quick chat about one of these topics? Send me a DM on{" "}
              <a
                target="_blank"
        ...
        <nav class="border-b border-gray-200 mt-10">
          <ul class="flex flex-wrap -mb-px">
            {ROUTES.map((route) => {
              return (
                <li
                  class={clsx(
                    "uppercase tracking-widest text-sm font-semibold px-4 py-2 border-b-2 cursor-pointer",
                    {
                      "border-white":
                        (route.href === "/" && pathname === "/") ||
